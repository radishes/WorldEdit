...
namespace WorldEdit.Commands
{
    public class ReplaceWallCommand : WECommand
    {
        ...
        public override void Execute()
        {
            ...
            string wallName1 = "wall " + wall1;
            if (wall1 == 0)
            {
                wallName1 = "air";
            }
            string wallName2 = "wall " + wall2;
            if (wall2 == 0)
            {
                wallName2 = "air";
            }
            TShock.Players[plr].SendMessage(String.Format("Replaced {0} with {1}. ({2})", wallName1, wallName2, edits), Color.Green);
        }
    }
}
